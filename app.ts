...
// We can also add callbacks as parameters AND specify types for those callbacks (both for their parameters and their return types).
...
// This now tells us that combineValues should accept any function with two parameters, each of which should be a number, and returns a number.
...
// Add an anonymous function that meets the type requirements set forth in the addAndHandle definition.
