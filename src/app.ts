...
// This really only works with primitive types because of the way objects are stored and referenced in JS -- hence the constraints to primitive types in the class definition.
